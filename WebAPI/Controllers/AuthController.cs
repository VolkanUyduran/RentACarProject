...
namespace WebAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            var userExist = _authService.UserExist(jwtUserForRegisterDto.Email);
            if (!userExist.Success)
            {
                return BadRequest(userExist.Message);
            }
            var registerResult = _authService.Register(jwtUserForRegisterDto, jwtUserForRegisterDto.Password);
